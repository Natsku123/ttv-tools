...
import {createTeam, deleteTeam, getTeams} from "@/services/teams";
...
export default function TeamsPage() {
    ...
    const {
        ...
        error,
        isLoading
    }: UseQueryResult<Array<Team>, AxiosError> = useQuery(["teams"], getTeams);
                ...
                <Grid item xs={12} md={6}>
                    {!isLoading ? <>
                        { teams && teams.length > 0 ? <>
                            {teams.map((team) => <Paper key={team.uuid}>
                                <Box py={2} px={2} my={2}>
